...
import { loginUser, firebaseLoginAPI } from '../api/auth.api';
    ...
    <div className="flex-grow flex items-center justify-center p-4 py-12 w-full min-h-screen">
      ...
      >
        ...
        <div className="p-8 bg-surface rounded-2xl border border-primary/20 shadow-2xl shadow-primary/5">
          ...
          <p className="text-textSoft text-center mb-8 text-sm">Log in to continue to Nexus</p>
          ...
          {/* ── Google Button (exactly like the image) ── */}
          <motion.button
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <span className="text-textSoft text-xs uppercase tracking-widest">or continue with email</span>
            <div className="flex-1 h-px bg-white/10" />
          </div>
          ...
          <p className="text-center text-textSoft text-sm mt-6">
            ...
            <Link to="/register" className="text-primary hover:text-primaryLight font-semibold transition">
              Register
            </Link>
          </p>
        </div>
